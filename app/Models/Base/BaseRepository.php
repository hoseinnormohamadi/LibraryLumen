...
class BaseRepository
{
    ...
    public function getAll(array $params = [])
    {
        ...
        $page = (int)( array_get($params['inputs'], 'page') );
        ...
        $orderby = isset($params['inputs']['orderby']) ? $params['inputs']['orderby'] : 'created_at';
     ...
     * @return array
     */
    private function result_for_paginate($collection)
    {
        return [
